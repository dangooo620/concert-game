...
public class ControlEspecificoPanel : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            Debug.LogError("�No se encontr� el Panel Lateral! Revisa el nombre en el Input Debugger.");
        }
        else
        {
    ...
    void EjecutarAccion(string nombreBoton)
    {
        switch (nombreBoton)
        {
            ...
            default:
                Debug.Log($"Presionaste {nombreBoton}, pero a�n no tiene una instrucci�n espec�fica.");
                break;
        }
